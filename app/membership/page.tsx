    ...
    <div className="min-h-screen bg-[#060506] text-[#EDE8DE]">
      ...
      <section className="relative min-h-screen overflow-hidden bg-[#060506]">
        ...
        <div className="lg:hidden flex flex-col min-h-screen">
          ...
          <div className="relative z-10 flex-1 bg-[#060506] w-[90%] mx-auto pt-2 pb-14">
            <div className="w-full max-w-lg flex flex-col items-start gap-5">
              ...
              <p className="text-body-muted text-base sm:text-lg font-light leading-[1.85]  max-w-md">
        ...
        <div className="relative z-10 hidden lg:flex w-[90%] md:w-full max-w-6xl mx-auto pt-40 pb-20 min-h-screen items-center">
          <div className="w-full max-w-lg lg:max-w-xl flex flex-col items-start gap-5 md:gap-6">
            ...
            {/* <div className="w-8 h-px bg-gold" /> */}
            <p className="text-body-muted text-lg md:text-xl font-light leading-[1.85] max-w-md">
              Membership in Maison Vereen extends well beyond a single
              acquisition — it is an ongoing relationship between the House and
              the people who help compose its history.
            </p>
      ...
      <section className="relative bg-[#060506] py-20 md:py-28">
        <div className="w-[90%] md:w-full max-w-6xl mx-auto space-y-12 md:space-y-16">
          ...
          <p className="font-light text-center text-body-muted leading-[1.7] max-w-3xl mx-auto text-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 max-w-5xl mx-auto">
            <p className="text-body-muted font-light leading-[1.85] px-2 md:px-8 md:pr-10 pb-8 md:pb-0 border-b md:border-b-0 md:border-r border-gold/30">
            ...
            <p className=" font-light leading-[1.85] text-body-muted px-2 md:px-8 md:pl-10 pt-8 md:pt-0">
        ...
        <div className="w-[90%] md:w-full max-w-6xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
            {PILLARS.map((pillar) => (
              <article
                key={pillar.title}
                className="flex flex-col items-center text-center gap-4 border border-[#EDE8DE]/12 bg-[#0C0B0A] px-6 py-8 sm:px-7 sm:py-9"
              >
                <div className="text-gold">
                  <PillarIcon type={pillar.icon} />
                </div>
                <h3 className="font-sans text-[11px] sm:text-xs uppercase tracking-[0.28em] text-gold font-medium">
                  {pillar.title}
                </h3>
