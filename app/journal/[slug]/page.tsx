          ...
          <div className="relative w-full h-[40vh] sm:h-[50vh] md:h-[60vh] overflow-hidden bg-[#060606]">
            ...
            <div className="absolute bottom-0 left-0 right-0">
              <div className="max-w-215 mx-auto px-6 sm:px-8 md:px-14 pb-10 md:pb-14 space-y-4">
                ...
                <div
                  className="flex items-center gap-4 text-[#EDE8DE] font-light"
                  style={{ fontSize: "12px" }}
                >
          ...
          <section className="border-b border-white/5 bg-[#0D0D0D]">
            <div className="max-w-6xl mx-auto">
              <div
                ...
                } divide-y sm:divide-y-0 sm:divide-x divide-white/5`}
              >
                {prev && (
                  <Link
                  ...
                  >
                    <span
                      className="text-[#3A3530] uppercase tracking-[0.25em] font-medium flex items-center gap-2"
                      style={{ fontSize: "10px" }}
                    >
                ...
                {next && (
                  <Link
                    ...
                    className={`group flex flex-col gap-3 px-6 sm:px-8 md:px-14 py-10 hover:bg-white/2 transition-colors duration-300 ${
                      prev ? "sm:items-end sm:text-right" : ""
                    }`}
                  >
                    <span
                      className="text-[#3A3530] uppercase tracking-[0.25em] font-medium flex items-center gap-2"
