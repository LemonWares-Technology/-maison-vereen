...
const articles = [
  {
    ...
    excerpt: "A generation of creators is redefining what luxury means on the continent — not as aspiration, but as expression. The question is no longer 'what does the world think of Africa?' but 'what does Africa think of the world?'",
    date: "June 2024",
    readTime: "6 min read",
  },
  {
    ...
    excerpt: "True craftsmanship is not about perfection. It is about the intention behind every decision, every material, every hand-finished detail. Perfection is a destination. Craftsmanship is a practice.",
    date: "May 2024",
    readTime: "4 min read",
  },
  {
    ...
    excerpt: "The things that endure are rarely announced. They are built carefully, consistently, over decades — without the need for applause. The loudest rooms are often the emptiest.",
    date: "April 2024",
    readTime: "5 min read",
  },
  {
    ...
    excerpt: "There is something distinct about being first. Not the first to know about something — but the first to believe in it enough to act. Early ownership of anything serious is an act of judgment.",
    date: "March 2024",
    readTime: "7 min read",
  },
  {
              ...
              {articles.map((a, i) => (
                ...
                >
                  ...
                  <div className="relative h-52 bg-[#0D0D0D] overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-[#1a1a1a] to-[#080808] group-hover:from-[#202020] transition-all duration-700" />
                    <div className="absolute bottom-5 left-6">
                      <span
                        className="uppercase tracking-[0.2em] text-gold/60 border border-gold/20 px-2 py-1"
                        style={{ fontSize: "8px" }}
                      >
                        {a.tag}
                      </span>
                  ...
                  <div className="px-7 pt-7 pb-9 space-y-3">
                    ...
                    <div className="pt-3 flex items-center justify-between border-t border-white/[0.04]">
                      ...
                      <div className="flex items-center gap-3 text-[#3A3530]" style={{ fontSize: "9px" }}>
                        <span>{a.date}</span>
                        <span>·</span>
