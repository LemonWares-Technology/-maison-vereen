          ...
          <div className="w-[90%] md:w-full max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
              {PILLARS.map((p) => (
                ...
                >
                  <h3 className="font-sans text-[11px] sm:text-xs uppercase tracking-[0.22em] text-gold font-medium leading-snug">
                    {p.title}
                  </h3>
        ...
        >
          <div className="w-[90%] md:w-full max-w-6xl mx-auto space-y-12 md:space-y-14">
            <div className="text-center space-y-3">
              ...
              <p className="text-[14px] md:text-lg font-light text-body-muted">
              ...
              {SIGNATURE_BOTTLES.map((b) => (
                ...
                >
                  ...
                  <div className="flex flex-col flex-1 gap-3 px-4 pt-5 pb-5 -mt-10 relative z-10">
                    ...
                    <p className="text-body-muted text-[13px]text-sm md:text-[0.95rem] font-light leading-[1.7]  flex-1">
                      {b.desc}
                    </p>
                    <button
                      type="button"
          ...
          <div className="relative z-10 w-[90%] md:w-full max-w-6xl mx-auto py-16 md:py-24 lg:py-28">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              <div className="space-y-5 max-w-xl lg:ml-auto">
                ...
                <p className=" text-base md:text-lg font-light leading-[1.85] text-body-muted">
