            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[75vh]">
              ...
              <div className="flex items-center px-8 md:px-14 py-20 md:py-28">
                <div className="space-y-8 max-w-[460px]">
                  ...
                  >
                    <span>Discover Edition I</span>
                    <span className="text-gold">→</span>
                  </button>
                </div>
              </div>

              {/* Right — bottle image full bleed, dark atmosphere */}
              <div className="relative min-h-[420px] lg:min-h-0 bg-[#060608] overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#060608]/75 via-transparent to-[#060608]/20" />
                ...
                <div className="absolute bottom-8 left-8 space-y-1.5 z-10">
                  ...
                  <span className="block uppercase tracking-widest text-[#7A7068]" style={{ fontSize: "8px" }}>Maison Vereen</span>
                  <span className="block uppercase tracking-widest text-[#5A5448]" style={{ fontSize: "8px" }}>Edition I</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="border-t border-white/[0.05] bg-[#0D0D0D]">
          <div className="max-w-[1400px] mx-auto px-8 md:px-14 py-20 space-y-10">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-white/[0.04]">
              {features.map((f, i) => (
                <div key={i} className="bg-[#0D0D0D] px-7 py-10 space-y-4 hover:bg-white/[0.02] transition-colors duration-300">
          ...
          <div className="max-w-[1400px] mx-auto px-8 md:px-14 py-20 space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/[0.04]">
              {(["Top Notes", "Heart Notes", "Base Notes"] as const).map((label, i) => {
                ...
                return (
                  <div key={i} className="bg-[#0A0A0A] px-8 py-10 space-y-5">
                    <span className="text-[9px] uppercase tracking-[0.28em] text-[#5A5449] font-medium">{label}</span>
        ...
        <section className="border-t border-white/[0.05] bg-[#0D0D0D]">
          <div className="max-w-[1400px] mx-auto px-8 md:px-14 py-20 space-y-8 max-w-[720px]">
            ...
            >
              ...
              <em className="text-gold not-italic">One edition. No second chances.</em>
            </h2>
