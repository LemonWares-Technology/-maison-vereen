        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-9">
            ...
            <p
              ...
              style={{ fontSize: "13px" }}
            >
              Maison Vereen is a house of rare creation. Edition I is limited to 250 bottles. Access is by application only.
            </p>
            ...
            <div className="space-y-3 pt-1">
              <button
                ...
                style={{ fontSize: "10px", letterSpacing: "0.26em", borderColor: "rgba(201,168,76,0.5)" }}
              >
                <span className="uppercase font-medium">Apply for Access</span>
              </button>
              <p className="text-[#3A3530] font-light" style={{ fontSize: "10px" }}>
                Application does not guarantee allocation. All positions subject to review.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            <div className="relative w-64 h-64 md:w-72 md:h-72 rounded-full overflow-hidden border" style={{ borderColor: "rgba(201,168,76,0.12)" }}>
              <div
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-br from-[#0D0D0D]/30 via-transparent to-[#0D0D0D]/50" />
              {/* MV text overlay */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center space-y-1">
                  ...
                  <div className="w-8 h-px mx-auto" style={{ background: "rgba(201,168,76,0.25)" }} />
                  <span
                    className="block uppercase tracking-[0.2em]"
                    style={{ fontSize: "7px", color: "rgba(201,168,76,0.3)", fontFamily: "monospace" }}
                  >
                    Est. MMXXIV
                  </span>
                </div>
