...
export default function AccessSection() {
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6 sm:px-8 md:px-14 py-20 md:py-28 lg:py-40">
        <div className="max-w-[680px] mx-auto text-center space-y-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[#3A3530] font-light" style={{ fontSize: "14px" }}>
              Not ready to apply?{" "}
              <Link href="/waitlist" className="text-gold/50 hover:text-gold transition-colors">
