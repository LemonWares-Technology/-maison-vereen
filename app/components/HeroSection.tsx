  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#060504]/97 via-[#060504]/80 to-[#060504]/20" />
        {/* Bottom vignette */}
        <div className="absolute inset-0 bg-gradient-to-t from-[#060504]/90 via-transparent to-[#060504]/50" />
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-8 md:px-14 pt-[72px]">
        <div className="max-w-[680px] py-28 md:py-36 space-y-8">
          ...
          <h1
            ...
            style={{ fontSize: "clamp(3.2rem, 8vw, 7rem)", fontWeight: 300, letterSpacing: "-0.01em" }}
          >
            A NEW<br />
            CHAPTER<br />
            IN AFRICAN<br />
          ...
          >
            Maison Vereen is a fragrance house born from culture,
            crafted with intention, and created to endure.
          </p>
          ...
          <div className="anim-fade-up-d2 pt-1">
            <button
              onClick={onOpenApply}
              className="border border-[#E8E2D9]/40 hover:border-[#C9A84C] hover:text-[#C9A84C] px-6 py-2.5 text-[#E8E2D9] transition-all duration-500"
              style={{ fontSize: "9px", letterSpacing: "0.28em" }}
            >
              <span className="uppercase font-medium tracking-[0.28em]">Discover the House</span>
            </button>
          </div>
        </div>
      </div>
      ...
      >
        <div className="w-8 h-8 rounded-full border border-[#3A3028] group-hover:border-[#C9A84C]/50 flex items-center justify-center transition-all duration-300">
          <svg width="9" height="9" viewBox="0 0 10 10" fill="none" className="text-[#4A4038] group-hover:text-[#C9A84C] transition-colors duration-300">
