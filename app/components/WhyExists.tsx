...
const iconPillars = [
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
        ...
        <ellipse cx="12" cy="12" rx="3.5" ry="10" stroke="currentColor" strokeWidth="0.9" />
        <path d="M2 12h20M5 6.5c2.2 1.5 4.5 2.5 7 2.5s4.8-1 7-2.5M5 17.5c2.2-1.5 4.5-2.5 7-2.5s4.8 1 7 2.5" stroke="currentColor" strokeWidth="0.9" strokeLinecap="round" />
      </svg>
    ),
  ...
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
        <path d="M12 3l1.9 5.8H20l-5 3.6 1.9 5.8L12 14.6l-4.9 3.6 1.9-5.8L4 8.8h6.1L12 3z" stroke="currentColor" strokeWidth="0.9" strokeLinejoin="round" />
      </svg>
    ),
    label: "Modern Luxury",
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
        <path d="M12 2L3 7l9 5 9-5-9-5zM3 17l9 5 9-5M3 12l9 5 9-5" stroke="currentColor" strokeWidth="0.9" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  ...
  return (
    <section id="the-house" className="bg-[#0A0A0A] border-t border-white/[0.05]">
      <div className="max-w-[1400px] mx-auto">
          ...
          <div className="flex items-center px-8 md:px-14 lg:px-16 py-20 md:py-28">
            <div className="space-y-8 max-w-[460px]">
              ...
              >
                ...
                <em className="not-italic" style={{ color: "#C9A84C" }}>Guided by Vision.</em>
              </h2>
        ...
        {/* ── ICON PILLARS ── */}
        <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-y md:divide-y-0 divide-white/[0.04] border-t border-white/[0.05]">
          {iconPillars.map((p, i) => (
            <div
              key={i}
              className="group px-7 py-9 flex flex-col items-center gap-4 text-center hover:bg-white/[0.015] transition-colors duration-400"
            >
              <div className="text-[#C9A84C]/40 group-hover:text-[#C9A84C]/70 transition-colors duration-400">
                {p.icon}
              </div>
              <span
