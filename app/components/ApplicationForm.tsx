...
export default function ApplicationForm({ isOpen, onClose }: ApplicationFormProps) {
  ...
  const inputClass =
    "w-full bg-transparent border-b border-white/8 py-3.5 text-[13px] text-[#EDE8DE] placeholder-white/30 focus:outline-none focus:border-gold/60 transition-colors duration-300";
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-250 min-h-screen md:min-h-0 md:my-10 bg-charcoal border-0 md:border border-white/7 shadow-2xl grid grid-cols-1 md:grid-cols-[1fr_420px]">
        <button onClick={onClose} className="absolute top-5 right-5 z-10 text-[#EDE8DE] hover:text-[#E8E2D9] transition-colors duration-300 p-1" aria-label="Close">
          <X className="w-5 h-5" />
        </button>
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="space-y-2">
                ...
                <p className="text-[#EDE8DE] font-light leading-[1.7]" style={{ fontSize: "13px" }}>
              ...
              <div className="border-t border-white/6 pt-7 space-y-6">
                ...
                <div className="space-y-1.5">
                  <label className="text-xs uppercase tracking-[0.25em] text-[#EDE8DE] font-medium block">Full Name</label>
                  <p className="text-xs text-[#EDE8DE]" style={{ fontSize: "11px" }}>As it should appear on your Gold Ownership Card</p>
                  <input type="text" required placeholder="Your full name" value={form.name}
                    onChange={(e) => setForm({ ...form, name: e.target.value })} className={inputClass} />
                </div>
                {/* Email */}
                <div className="space-y-1.5">
                  <label className="text-xs uppercase tracking-[0.25em] text-[#EDE8DE] font-medium block">Email Address</label>
                  <p className="text-xs text-[#EDE8DE]" style={{ fontSize: "11px" }}>Your invitation will be sent here</p>
                  <input type="email" required placeholder="your@email.com" value={form.email}
                    onChange={(e) => setForm({ ...form, email: e.target.value })} className={inputClass} />
                </div>
                {/* Phone */}
                <div className="space-y-1.5">
                  <label className="text-xs uppercase tracking-[0.25em] text-[#EDE8DE] font-medium block">Phone Number — <span className="normal-case tracking-normal">Optional</span></label>
                ...
                {/* City & Country */}
                <div className="space-y-1.5">
                  <label className="text-xs uppercase tracking-[0.25em] text-[#EDE8DE] font-medium block">City &amp; Country</label>
                ...
                {/* What You Do */}
                <div className="space-y-1.5">
                  <label className="text-xs uppercase tracking-[0.25em] text-[#EDE8DE] font-medium block">What You Do</label>
                  <p className="text-xs text-[#EDE8DE]" style={{ fontSize: "11px" }}>What you build, lead, or create — in your own words, not your job title</p>
                ...
                {/* How heard */}
                <div className="space-y-1.5">
                  <label className="text-xs uppercase tracking-[0.25em] text-[#EDE8DE] font-medium block">How Did You Find Maison Vereen?</label>
                ...
                {/* Referred By */}
                <div className="space-y-1.5">
                  <label className="text-xs uppercase tracking-[0.25em] text-[#EDE8DE] font-medium block">If Referred, May We Know By Whom? — <span className="normal-case tracking-normal">Optional</span></label>
                ...
                {/* What Made You Apply */}
                <div className="space-y-1.5">
                  <label className="text-xs uppercase tracking-[0.25em] text-[#EDE8DE] font-medium block">What Made You Apply?</label>
                  <p className="text-xs text-[#EDE8DE]" style={{ fontSize: "11px" }}>In your own words — there is no expected answer</p>
                ...
                {/* Early to something */}
                <div className="space-y-1.5">
                  <label className="text-xs uppercase tracking-[0.25em] text-[#EDE8DE] font-medium block">Optional — A Time You Were Early To Something</label>
                  <p className="text-xs text-[#EDE8DE] leading-relaxed" style={{ fontSize: "11px" }}>Describe a moment when you recognised the value of something before most others did.</p>
                ...
                {/* Anything else */}
                <div className="space-y-1.5">
                  <label className="text-xs uppercase tracking-[0.25em] text-[#EDE8DE] font-medium block">Anything You&apos;d Like To Ask Or Tell Us? — <span className="normal-case tracking-normal">Optional</span></label>
                ...
                <label className="flex items-start gap-4 cursor-pointer group">
                  ...
                  <span className="text-xs text-[#EDE8DE] font-light leading-[1.7] tracking-wide">
            ...
            <div className="min-h-[60vh] flex flex-col items-center justify-center text-center space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-[#EDE8DE] font-light leading-[1.7] max-w-90 mx-auto" style={{ fontSize: "15px" }}>
                  Your application has been received. We will review it personally and respond within 48 hours.
                </p>
                <p className="text-[#EDE8DE] font-light" style={{ fontSize: "13px" }}>
                  Confirmation sent to <span className="text-gold">{form.email}</span>.
                </p>
              </div>
              <button onClick={onClose}
                className="border border-white/8 hover:border-white/20 px-8 py-3 text-[#EDE8DE] hover:text-[#E8E2D9] transition-all duration-300"
        ...
        <div className="hidden md:block relative bg-[#060606] overflow-hidden border-l border-white/4">
          ...
          <div className="absolute bottom-10 left-8 space-y-2">
            ...
            <span className="block font-serif font-light text-[#EDE8DE]/50 tracking-[0.3em] uppercase" style={{ fontSize: "9px" }}>Edition I</span>
            <span className="block text-[#EDE8DE]/30 font-mono tracking-widest uppercase" style={{ fontSize: "8px" }}>250 Bottles · The Founding Expression</span>
          </div>
        </div>
      </div>
    </div>
