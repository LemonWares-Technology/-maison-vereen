      ...
      <div className="max-w-[1400px] mx-auto px-8 md:px-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-6 pb-14 border-b border-white/[0.06]">
          ...
          <div className="space-y-5">
            ...
            <p className="text-[9px] uppercase tracking-[0.22em] text-[#5A5449] font-light">
          ...
          <nav className="space-y-3.5" aria-label="Footer navigation">
            {NAV_LINKS.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="block text-[9.5px] uppercase tracking-[0.25em] text-[#5A5449] hover:text-[#E8E2D9] transition-colors duration-300 font-medium w-fit"
              >
                {link.label}
              </Link>
            ))}
          ...
          <div className="space-y-5">
            <span className="text-[9px] uppercase tracking-[0.25em] text-[#8A8178] font-medium">
              Connect
            </span>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-6 gap-4">
          <span className="text-[9px] uppercase tracking-[0.2em] text-[#3A3530] font-light">
            © 2024 Maison Vereen. All Rights Reserved.
          </span>
          <div className="flex items-center gap-5 text-[9px] uppercase tracking-[0.2em] text-[#4A4540] font-medium">
